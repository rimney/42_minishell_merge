...
void		ft_redirect_after_pipe_flag(t_exec *exec,
				t_pipe *tpipe, int index, int in_save);
void		ft_advanced_redirect(int index, t_exec *exec,
...
int			ft_heredoc_final_case_child(t_exec *exec, int index,
				int fd[2], int out);
int			ft_find_next_flag_heredoc(t_exec *exec, int *index,
				int *fd, int *in);
...
void		ft_heredoc_write(int fd[2], char *line);
int			ft_exec_heredoc(t_exec *exec, int index,
				int fd[2], int command_loaction);
void		ft_heredoc(t_exec *exec, int command_location, int index);
int			ft_basic_heredoc(t_exec *exec, int index);
void		ft_advanced_heredoc(t_exec *exec, int index, int command_location);
int			ft_find_next_flag_heredoc(t_exec *exec, int *index,
...
int			ft_find_next_flag_heredoc(t_exec *exec,
				int *index, int *fd, int *in);
...
void		ft_apply_redirection_after_pipe(int out, t_pipe *tpipe,
				t_exec *exec, int index);
int			ft_minishell_executor2(t_exec *exec, t_pipe *tpipe,
				int i, int flag);
